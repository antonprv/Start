...
namespace FastMath
{
    ...
    public static partial class FMath
    {
        ...
        public static Vector3 FastToEulerZYX(this in Quaternion q)
        {
            ...
            float roll = FMath.FastAtan2(sinr_cosp, cosr_cosp, precise: false);
            ...
            float yaw = FMath.FastAtan2(siny_cosp, cosy_cosp, precise: false);
        ...
        public static Vector3 FastToEulerZYXDegrees(this in Quaternion q)
        {
            ...
            const float RAD_TO_DEG = 180f / 3.14159274f;  // Rad2Deg
        ...
        public static Vector3 FastToEulerXYZ(this in Quaternion q)
        {
            ...
            float cosy_cosp = 1f - 2f * (y * y + z * z);
            float pitch = FMath.FastAtan2(siny_cosp, cosy_cosp, precise: false);

            // Yaw (Z rotation)
            float sinz_cosp = 2f * (w * z - x * y);
            float cosz_cosp = 1f - 2f * (z * z + y * y);
            float yaw = FMath.FastAtan2(sinz_cosp, cosz_cosp, precise: false);
        ...
        public static Vector3 FastToEulerXYZDegrees(this in Quaternion q)
        {
            ...
            const float RAD_TO_DEG = 180f / 3.14159274f;
            return euler * RAD_TO_DEG;
        }
