...
namespace Framework.FastMath.Godot.Extensions
{
	/// <summary>
	/// Extension methods for convenient usage directly on Godot types.
	/// All methods delegate to Framework.FastMath.Godot.FMath - no logic lives here.
