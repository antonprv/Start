...
// FMath, so a consumer only needs `using Framework.FastMath.Godot;` to get
// both the Godot-specific vector/quaternion math AND the shared scalar math -
...
// from this assembly's own Godot-specific files via `using static
