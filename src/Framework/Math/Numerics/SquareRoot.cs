...
//
// NOTE ON DUPLICATION: this is intentionally NOT shared with
// Numerics/FastMath/SquareRoot.cs via an interface or converter - both files
// implement the same operations directly against their own vector type
// (System.Numerics.Vector3 here, Godot.Vector3 in the sibling Godot/FastMath project) so every call stays a
// plain static method call with zero indirection. Only the pure-scalar math
// (FastInvSqrt, SafeScaleFor, AbsBranchless, ...) is shared, from
// Framework.FastMath.Core.
...
namespace Framework.FastMath.Numerics
{
    ...
    /// System.Numerics.Vector2 / System.Numerics.Vector3 / System.Numerics.Quaternion.
    ///
    /// Hack catalogue:
    ...
    public static partial class FMath
    {
        ...
        // ----------------------------------------------------------------
        // Quaternion.IsNormalized - Normalize itself lives in FastQuaternion.cs
        // ----------------------------------------------------------------
        ...
        /// <summary>Fast 3-D length of a System.Numerics.Vector3. Overflow-safe.</summary>
        [MethodImpl( MethodImplOptions.AggressiveInlining )]
