...
namespace BepuPhysics.CollisionDetection.SweepTasks
{
...

	{
		...
		protected override unsafe bool PreorderedTypeSweep(
			...
			in BodyVelocity velocityA, void* shapeDataB, in RigidPose localPoseB,
			Vector3 offsetB, Quaternion orientationB, in BodyVelocity velocityB,
			float maximumT, float minimumProgression, float convergenceThreshold,
			int maximumIterationCount, out float t0, out float t1, out Vector3 hitLocation,
