...
namespace BepuPhysics.Constraints
{
    ...
    public interface IThreeBodyConstraintFunctions<TPrestepData, TAccumulatedImpulse>
    {
        ...
        static abstract void IncrementallyUpdateForSubstep( in Vector<float> dt, in BodyVelocityWide wsvA, in BodyVelocityWide wsvB, in BodyVelocityWide wsvC, ref TPrestepData prestepData );
    }
        ...
        where TSolveAccessFilterC : unmanaged, IBodyAccessFilter
    {
        ...
        struct ThreeBodySortKeyGenerator : ISortKeyGenerator<ThreeBodyReferences>
        {
            ...
            public static int GetSortKey( int constraintIndex, ref Buffer<ThreeBodyReferences> bodyReferences )
            {
            ...
            float dt, float inverseDt, int startBundle, int exclusiveEndBundle, int workerIndex )
        {
            ...
            for ( int i = startBundle; i < exclusiveEndBundle; ++i )
            {
                ...
                TConstraintFunctions.WarmStart( positionA, orientationA, inertiaA, positionB, orientationB, inertiaB, positionC, orientationC, inertiaC, ref prestep, ref accumulatedImpulses, ref wsvA, ref wsvB, ref wsvC );
        ...
        public override void Solve( ref TypeBatch typeBatch, Bodies bodies, float dt, float inverseDt, int startBundle, int exclusiveEndBundle )
        {
            ...
            for ( int i = startBundle; i < exclusiveEndBundle; ++i )
            {
                ...
                TConstraintFunctions.Solve( positionA, orientationA, inertiaA, positionB, orientationB, inertiaB, positionC, orientationC, inertiaC, dt, inverseDt, ref prestep, ref accumulatedImpulses, ref wsvA, ref wsvB, ref wsvC );
        ...
        public override void IncrementallyUpdateForSubstep( ref TypeBatch typeBatch, Bodies bodies, float dt, float inverseDt, int startBundle, int exclusiveEndBundle )
        {
            ...
            for ( int i = startBundle; i < exclusiveEndBundle; ++i )
            {
                ...
                TConstraintFunctions.IncrementallyUpdateForSubstep( dtWide, wsvA, wsvB, wsvC, ref prestep );
            }
        }
    }
}
