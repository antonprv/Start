...
{
    /// <summary>
    /// Describes the properties of a static object. 
    /// When added to a simulation, static objects can collide but have no velocity and will not move in response to forces.
    /// </summary>
