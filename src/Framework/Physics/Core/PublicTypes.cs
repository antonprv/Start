...
{   /// <summary>
    ...
    public readonly struct CharacterMoveOptions
    {
        ...
        public CharacterMoveOptions( int maxSlideIterations = 4, float skinWidth = 0.015f, float maxFloorAngleDegrees = 46f, float floorProbeDistance = 0.08f )
        {
    ...
    public readonly struct ShapeCastResult
    {
        ...
        public ShapeCastResult( bool hit, Vector3 position, Vector3 point, Vector3 normal, float distance, int hitOwnerId )
        {
            Hit = hit;
            Position = position;
            Point = point;
    ...
    public readonly struct ProjectileSweepResult
    {
        ...
        public ProjectileSweepResult( bool hit, Vector3 position, Vector3 point, Vector3 normal, int hitOwnerId )
        {
            Hit = hit;
            Position = position;
            Point = point;
